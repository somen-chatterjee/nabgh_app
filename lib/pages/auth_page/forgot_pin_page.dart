...
class ForgotPinInputPage extends StatefulWidget {
  ...
  @override
  State<ForgotPinInputPage> createState() => _ForgotPinInputPage();

  @override
  String toStringShort() => 'Rounded With Cursor';
}

class _ForgotPinInputPage extends State<ForgotPinInputPage> {
                      ...
                      child: Pinput(
                        ...
                        onCompleted: (pin) async {
                          ...
                          await context
                              ...
                              .verifyOtp(context: context, otp: pin.toString())
                          .then((value) {
                      ...
                      return SizedBox(
                        ...
                        child: AppSmallButton(
                          ...
                          onTap: () {
                            ...
                            if(pin.isEmpty) {
                              AppConstants.getToast(message: LocalizationManager().translate('enterOtp'));
                            } else if(pin.length < 4) {
                              AppConstants.getToast(message:  LocalizationManager().translate('enterCompleteOtp'));
                            }
